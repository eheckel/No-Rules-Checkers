...
public class CheckersController {
	...
	private void handleRectangle(MouseEvent event) {
		...
		System.out.println("current2: " + _currentColor);
		System.out.println("prev2: " + _prevColor);
	...
	private void handleCircle(MouseEvent event) {
		...
		System.out.println(targetCircle.getFill().toString());
		System.out.println(column + ", " + row);
	}

	// the remains from the rules window we tried to make but got too lazy to
	// fix
	public RulesWindow handleClick() {
